...
merge_named_vectors(x=x$strSums$orphans, y=y$strSums$orphans, .fill=0)
merge_named_vectors(x=x$strSums$s1, y=y$strSums$s1, .fill=0)
merge_named_vectors(x=x$strSums$s2, y=y$strSums$s2, .fill=0)
merge_named_vectors(x=x$strSums$s3, y=y$strSums$s3, .fill=0)
merge_named_vectors(x=x$strSums$s4, y=y$strSums$s4, .fill=0)
merge_named_vectors(x=x$strSums$s5, y=y$strSums$s5, .fill=0)
```
